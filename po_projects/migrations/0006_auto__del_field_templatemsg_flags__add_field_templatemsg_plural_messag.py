...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'po_projects_templatemsg', 'flags')

        # Adding field 'TemplateMsg.plural_message'
        db.add_column(u'po_projects_templatemsg', 'plural_message',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'po_projects_templatemsg', 'flags',
                      self.gf('django.db.models.fields.TextField')(),
                      keep_default=False)

        # Deleting field 'TemplateMsg.plural_message'
        db.delete_column(u'po_projects_templatemsg', 'plural_message')
